...
### 워크샵 컨셉 ###
- 주제: "에이전트를 만드는 것만이 아니라, Graviton 위에서 싸게 굴리는 것까지" 
- 차별점: 다른 LangGraph 워크샵들과 달리 AI 워크로드의 인프라 경제학을 실측으로 다룸
- 청중 관점: "AI 에이전트 도입했는데 비용이 감당 안 된다"는 고민을 가진 플랫폼/DevOps 엔지니어에게 특히 꽂힐 구성
